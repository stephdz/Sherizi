...
public final class Users extends GenericJson {
   ...
   */
  public Users setItems(java.util.List<User> items) {
    this.items = items;
    return this;
  }
   ...
   * example, a request that returns a single {@link Users} would include the response headers,
   * while a request which returns an array of {@link Users}, would have a non-null response header
